...
| `python/ck_dsl/dsl_docs/optimization/gfx942_playbook.md` | gfx942/CDNA3-specific optimization facts that do NOT transfer to gfx950 (ISA constraints, no-transpose-read operand feed, occupancy + compile-time budgets). |
